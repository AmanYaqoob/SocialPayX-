...
class ApiService {
  ...
  async register(email, password, username, referralCode) { return this.request('/auth/register', { method: 'POST', body: { email, password, username, referralCode } }); }
  ...
  async createPost(content, imageUrl = null) { return this.request('/feed', { method: 'POST', body: { content, imageUrl } }); }
