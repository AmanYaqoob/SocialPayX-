...
const Landing = () => {
  ...
  const features = [
    { icon: Zap, title: "Instant Mining", description: "Start mining SPX tokens immediately with zero setup required" },
    { icon: Shield, title: "Secure Platform", description: "Bank-grade security with advanced KYC verification" },
    { icon: Users, title: "Referral Rewards", description: "Earn bonus tokens by inviting friends to the platform" },
    { icon: Coins, title: "Daily Rewards", description: "Claim your mined tokens daily and watch your balance grow" },
  ];
    ...
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <header className="relative z-10 flex items-center justify-between p-4 md:p-6 max-w-7xl mx-auto">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a href="/whitepaper" className="text-muted-foreground hover:text-foreground transition-colors">Whitepaper</a>
        </nav>
      ...
      <section id="features" className="relative z-10 px-4 py-20 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Why Choose SPX Mining?</h2>
      ...
      <footer className="relative z-10 border-t border-border px-4 py-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            <a href="https://x.com/socialpay_x" target="_blank" rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-card border border-border flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-primary/50 transition-all" aria-label="Follow us on X">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
            </a>
            <a href="https://www.facebook.com/profile.php?id=61587974789291" target="_blank" rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-card border border-border flex items-center justify-center text-muted-foreground hover:text-[#1877F2] hover:border-[#1877F2]/50 transition-all" aria-label="Follow us on Facebook">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </a>
            <a href="https://www.instagram.com/socialpay_x?igsh=MWFreTdvejQydWxxbQ==" target="_blank" rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-card border border-border flex items-center justify-center text-muted-foreground hover:text-[#E1306C] hover:border-[#E1306C]/50 transition-all" aria-label="Follow us on Instagram">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
            ...
            <a href="https://whatsapp.com/channel/0029Vb6urAcG3R3f1xgOCS3i" target="_blank" rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-card border border-border flex items-center justify-center text-muted-foreground hover:text-[#25D366] hover:border-[#25D366]/50 transition-all" aria-label="Join us on WhatsApp">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
          ...
          <div className="flex items-center gap-6 text-sm text-muted-foreground">
            ...
            <a href="/whitepaper" className="flex items-center gap-1.5 px-3 py-1.5 bg-primary/10 border border-primary/30 rounded-lg text-primary hover:bg-primary/20 transition-colors font-medium">
              <svg viewBox="0 0 24 24" className="w-3.5 h-3.5" fill="currentColor"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zm-1 1.5L18.5 9H13V3.5zM6 20V4h5v7h7v9H6z"/></svg>
              Whitepaper
            </a>
          </div>
