      ...
      <footer className="relative z-10 border-t border-border px-4 py-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            <a href="https://x.com/SocialPayX" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://www.instagram.com/socialpayx?igsh=bzIyZGNqYjZ6NWVn" target="_blank" rel="noopener noreferrer"
